...
@Component({
  selector: 'app-house-owner-registration-payment-mode-upi',
  templateUrl: './house-owner-registration-payment-mode-upi.component.html',
  styleUrls: ['../../common.css','./house-owner-registration-payment-mode-upi.component.css']
})
export class HouseOwnerRegistrationPaymentModeUPIComponent {
  tableData = [
