...
disableElectricAddButton:boolean=false;
  addelectric() {
    ...
    if (lastElectricIndex >= 0) {
      ...
      if (
        ...
        if(this.agreementEleWatData!=null){
          if(this.agreementEleWatData.house.noOfEleBills===this.electric.length){
            this.disableElectricAddButton=false;
          }
          else{
            this.disableElectricAddButton=true;
          }
        }
      } else {
  ...
  disableWaterAddButton:boolean=false;
  addwater() {
    ...
    if (lastWaterIndex >= 0) {
      ...
      if (lastWaterGroup.get('waterExpenseAmount')?.value !== '' ||
        ...
        if(this.agreementEleWatData!=null){
          if(this.agreementEleWatData.house.noOfWtrBills===this.water.length){
            this.disableWaterAddButton=false;
          }
          else{
            this.disableWaterAddButton=true;
          }
        }
      } else {
